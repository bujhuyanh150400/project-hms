<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-2">
        <div class="form-group" id="provinces-container" style="display: none">
            <label for="provinces" class="@error($province) form-label-error @else form-label @enderror">Chọn Tỉnh/Thành phố</label>
        ...
        <div class="form-group" id="wards-container" style="display: none">
            ...
            @error($ward)<span class="form-alert">{{ $message }}</span>@enderror
        </div>
    </div>
