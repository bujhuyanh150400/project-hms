    ...
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex items-center gap-4">
            ...
            >
                ...
                >
                    <li>
                        <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-100 ">Thông tin cá nhân</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Đăng xuất</a>
                    </li>
                </ul>
            </div>
            <!-- End: User -->
