        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="bi bi-chevron-right"></i>
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Sửa Khách hàng</span>
                </div>
            </li>
        </ol>
    </nav>
    {{-- End: Navigation --}}
    <form class="form-loading-submit" action="{{ route('customer.edit',['id' => $customer->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="birth" id="birth" value="{{ old('birth', $customer->birth) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" id="gender"
                            ...
                            <option value="1" @if ((int) old('gender',$customer->gender) === 1) selected @endif>Nam</option>
                            <option value="2" @if ((int) old('gender',$customer->gender) === 2) selected @endif>Nữ</option>
                        </select>
                        @error('gender')
                        <span class="form-alert">{{ $message }}</span>
                        @enderror
                ...
                <div class="">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <textarea class="ckeditor" name="description" id="description">{{ old('description',$customer->description) }}</textarea>
                        @error('description')
                        <span class="form-alert">{{ $message }}</span>
                        @enderror
                    </div>
