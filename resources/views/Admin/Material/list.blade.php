            ...
            <div class="grid grid-cols-4 gap-3 mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="filter[keyword]" id="keyword"
                        ...
                        placeholder="Tìm kiếm theo tên cơ sở, id">
                </div>
                <div class="form-group">
                    <label class="form-label" for="active">Cơ sở hoạt động</label>
                    <select id="active" name="filter[active]" class="form-input">
                        <option value="">Chọn</option>
                        <option value="2" {{ old('filter.active', $filter['active'] ?? '') == 2 ? 'selected' : '' }}>
                            Không hoạt động</option>
                        <option value="1" {{ old('filter.active', $filter['active'] ?? '') == 1 ? 'selected' : '' }}>
                ...
                <x-slot:body>
                    @foreach ($clinics as $clinic)
                        <tr>
                            ...
                            <td>
                                <img class="w-[200px] h-[200px] rounded"
