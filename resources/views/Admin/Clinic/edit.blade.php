        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <a href="{{route('clinic.list')}}" class="flex items-center">
                    ...
                    <span
                        class="ms-1 text-sm font-medium text-gray-500 hover:text-blue-600">Danh sách phòng khám</span>
                </a>
            </li>
        ...
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow ">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="flex items-start justify-center flex-col gap-2">
                        ...
                        <div class="form-group w-full mt-8">
                            <input
                                ...
                                type="file">
                            @error('logo')<span class="form-alert">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-3">
                    ...
                    <div class="form-group">
                        <label for="active" class=" @error('active') form-label-error @else form-label @enderror">Trạng thái hoạt động</label>
                        <select
                            class=" @error('active') form-input-error @else form-input @enderror"
                            id="active"
                            name="active"
                        >
