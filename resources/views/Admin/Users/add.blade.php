        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="bi bi-chevron-right"></i>
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Thêm nhân sự</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow ">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="flex flex-col gap-2">
                    ...
                    <div class="form-group">
                        <label for="password" class=" @error('password') form-label-error @else form-label @enderror"><i
                    ...
                    <div class="form-group">
                        <label for="password" class=" @error('conf_pass') form-label-error @else form-label @enderror"><i
                        ...
                        <select name="permission" id="permission"
                            ...
                            @foreach (PermissionAdmin::getList() as $permission)
                                <option value="{{ $permission['value'] }}"
                                    @if ((int) old('permission') === $permission['value']) selected @endif>
                    ...
                    <div class="form-group">
                        <label for="clinic_id"
                            class=" @error('clinic_id') form-label-error @else form-label @enderror">Cơ sở
                            trực thuộc</label>
                        <select id="clinic_id" name="clinic_id"
                            ...
                            @foreach ($listClinic as $clinic)
                                <option value="{{ $clinic->id }}" @if (old('clinic_id') == $clinic->id) selected @endif>
                    ...
                    <div class="form-group">
                        ...
                        <select id="specialties_id" name="specialties_id"
                            ...
                            @foreach ($listSpecialties as $specialty)
                                <option value="{{ $specialty->id }}" @if (old('specialties_id') == $specialty->id) selected @endif>
                        ...
                        <select id="user_status" name="user_status"
                            ...
                            @foreach ($listUserStatus as $userStatus)
                                <option value="{{ $userStatus['value'] }}"
                                    @if (old('user_status') == $userStatus['value']) selected @endif>
