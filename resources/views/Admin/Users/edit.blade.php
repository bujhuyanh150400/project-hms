        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="bi bi-chevron-right"></i>
                    <span
                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2">{{$title}}</span>
                </div>
            </li>
        </ol>
    </nav>
                ...
                <div class="form-group">
                    ...
                    <select name="permission" id="permission"
                        ...
                        @foreach(PermissionAdmin::getList() as $permission)
                            <option value="{{$permission['value']}}" @if ((int) old('permission',$user->permission) === $permission['value']) selected @endif>{{$permission['text']}}</option>
                        @endforeach
                    </select>
