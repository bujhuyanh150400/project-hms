...
@section('body')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <a href="{{ route('specialties.list') }}" class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 hover:text-blue-600">Danh sách chuyên khoa</span>
                </a>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="bi bi-chevron-right"></i>
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Thêm chuyên khoa </span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <form class="form-loading-submit" action="{{ route('specialties.add') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow ">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="flex flex-col gap-2">
                    <div class="form-group">
                        <label for="name" class=" @error('name') form-label-error @else form-label @enderror"> Tên
                            chuyên khoa </label>
                    ...
                    <div class="flex items-start justify-center flex-col gap-2">
                        <label for="logo"
                            class="flex items-center gap-2 text-sm font-medium @error('logo') text-red-500  @else text-blue-700 @enderror">
                            Ảnh đại diện chuyên khoa</label>
                        <div
            ...
            <div class="flex justify-end items-center gap-2">
                <a href="{{ route('specialties.list') }}" class="btn-custom btn-default"><i class="bi bi-arrow-left"></i>Quay
                    lại</a>
